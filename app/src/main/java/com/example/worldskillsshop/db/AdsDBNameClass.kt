...
object AdsDBNameClass {
    ...
    const val DATABASE_VERSION = 170  //версия
    const val DATABASE_NAME = "MyDb.db"  //Название

    const val CREAT_TABLE = "CREATE TABLE IF NOT EXISTS $TABLE_NAME ("+
            "${BaseColumns._ID} INTEGER PRIMARY KEY,$PriceADS TEXT,$Description TEXT,$Phone TEXT,$COLUMN_titleADS TEXT,$AddImageA TEXT,$AddImageB TEXT,$AddImageC TEXT, $AddImageD TEXT)"
